...
var init = function init () {
  ...
  client.init(function loaded () {
    ...
    function show (event) {
      ...
      options.fasting = $('#rp_optionsfasting').is(':checked');
      
      console.log('🔢 REPORTCLIENT BUILD: FASTING-DEBUG-v2.8-FIX-CURRENT-DAY - 2026-01-28-09:45 EST');
      console.log('📋 Fasting checkbox state:', options.fasting);
