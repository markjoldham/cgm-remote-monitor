...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  console.log('🔢 BUILD: FASTING-DEBUG-v2.8-FIX-CURRENT-DAY - 2026-01-28-09:45 EST');
    ...
    if (bestPeriods.length > 0) {
      ...
      bestPeriods.forEach(function(period) {
        ...
        if (period.glucoseStats) {
          fastingHtml += '<br><small>Avg BG: ' + period.glucoseStats.mean.toFixed(0) + ' mg/dL, ';
          fastingHtml += 'Stability: ' + period.glucoseStats.stability + '%, ';
          fastingHtml += 'Range: ' + period.glucoseStats.range.toFixed(0) + ' mg/dL</small>';
        }
        fastingHtml += '</li>';
      });
      fastingHtml += '</ul>';
          ...
          if (rectWidth > 0) {
            ...
            context.append('rect')
              ...
              .on('mouseover', function() {
                ...
                if (period.glucoseStats) {
                  tooltipText += 'Avg BG: ' + period.glucoseStats.mean.toFixed(0) + ' mg/dL<br/>' +
                    'Stability: ' + period.glucoseStats.stability + '%<br/>' +
                    'Range: ' + period.glucoseStats.range.toFixed(0) + ' mg/dL';
                }
