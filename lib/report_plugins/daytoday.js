...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  console.log('🔢 BUILD: FASTING-DEBUG-v3.6-USE-USER-TARGETS - 2026-01-28-12:15 EST');
  ...
  if (fastingDetection) {
    ...
    sorteddaystoshow.forEach(function(day, index) {
      ...
      var fastingPeriods = fastingDetection.detectFastingPeriods(dayData, nextDayData, options);
