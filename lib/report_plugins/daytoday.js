...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  console.log('🔢 BUILD: FASTING-DEBUG-v3.3-FIX-DAY-ORDER - 2026-01-28-11:30 EST');
          ...
          if (rectWidth > 0) {
            ...
            context.append('rect')
              ...
              .on('mouseover', function() {
                ...
                var tooltipText = '<b>Fasting Period</b><br/>' +
                  'Duration: ' + period.duration.toFixed(1) + ' hours<br/>' +
                  'Type: ' + period.periodType + '<br/>' +
            ...
            // Add label for high-quality periods
            if (period.quality === 'excellent' || period.quality === 'good') {
              ...
              context.append('text')
                ...
                .text('FASTING (' + period.duration.toFixed(1) + 'h)');
            }
          }
        }
      });
