...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  console.log('🔢 BUILD: FASTING-DEBUG-v3.5-FIX-CURRENT-DAY-AGAIN - 2026-01-28-12:00 EST');
  ...
  if (fastingDetection) {
    ...
    sorteddaystoshow.forEach(function(day, index) {
      ...
      var fastingPeriods = fastingDetection.detectFastingPeriods(dayData, nextDayData);
  ...
  if (options.fasting && allFastingPeriods.length > 0) {
    ...
    if (bestPeriods.length > 0) {
      ...
      bestPeriods.forEach(function(period) {
        ...
        if (period.glucoseStats) {
          ...
          fastingHtml += '<br>';
          fastingHtml += 'Time in Range: ' + period.glucoseStats.timeInRange + '% (70-180 mg/dL), ';
    ...
    fastingHtml += '<td style="padding: 5px; border: 1px solid #ddd;">Percentage of readings between 70-180 mg/dL.</td>';
            ...
            context.append('rect')
              ...
              .on('mouseover', function() {
                ...
                if (period.glucoseStats) {
                  ...
                  tooltipText += 'Time in Range: ' + period.glucoseStats.timeInRange + '%<br/>';
