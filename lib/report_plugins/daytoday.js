...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  if (options.fasting) {
    console.log('Fasting option is enabled, proceeding with detection...');
    ...
    if (fastingDetection) {
      ...
      console.warn('Fasting detection module not available');
    }
  } else {
    console.log('Fasting option is NOT enabled - checkbox probably not checked');
  }
