...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  console.log('🔢 BUILD: FASTING-DEBUG-v3.8-FIX-TARGET-VALIDATION - 2026-01-28-13:00 EST');
            ...
            context.append('rect')
              ...
              .on('mouseover', function() {
                ...
                if (period.glucoseStats) {
                  ...
                  tooltipText += 'Range: ' + period.glucoseStats.min + '-' + period.glucoseStats.max + ' mg/dL (' + period.glucoseStats.range + ')<br/>';
